...
export const SOCIAL_PROFILES: IconLink[] = [
  ...
  // Facebook was removed at the client's request on 31 August 2026 — temporarily. To put it
  // back, restore this entry; nothing else needs changing, because the icon row and the
  // Organization `sameAs` both derive from this array.
  //   { name: 'Facebook', href: 'https://www.facebook.com/share/18yMzVmEp9/',
